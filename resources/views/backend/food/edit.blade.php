    ...
    <div class="container-fluid">
        <div class="row page-titles">
            <div class="col-md-5 col-8 align-self-center">
                <h3 class="text-themecolor m-b-0 m-t-0">Form Edit Food</h3>
                <ol class="breadcrumb">
                                            ...
                                            <div class="col-md-6">
                                                <div class="card">
                                                    <div class="card-body">
                                                        ...
                                                        <input name="image" data-default-file="{{ asset('/images/'.$food->image) }}" data-max-file-size="1M" type="file" id="input-file-now" class="dropify form-control" />
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input name="name" required value="{{ $food->name }}" type="text" id="name" class="form-control"
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="controls">
                                                <input value="{{ $food->price }}" type="text" name="price" class="form-control" required
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="controls">
                                                <input value="{{ $food->category }}" type="text" name="category" id="category" class="form-control" placeholder="Enter category">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <textarea name="description" id="description" class="form-control" cols="30" rows="10" placeholder="Enter food description">{{ $food->description }}</textarea>
                                        </div>
                                    </div>
                                </div>
